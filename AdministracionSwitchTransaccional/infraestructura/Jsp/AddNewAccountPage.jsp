...
<salmon:page controller="infraestructura.controllers.AddNewAccountController" />
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" width="100%">
                      ...
                      <tr > 
                        <td > <salmon:table name="tableContactInfo" width="-1%" border="0">
                            ...
                            <tr> 
                              <td align="Right"> <salmon:text name="capTeCity"  font="EmphasisFont" text="City goes here" textlocalekey="lblCity"/> </td>
                              <td width="10" > </td>
                            ...
                            <tr> 
                              <td align="Right"> <salmon:text name="capDdlState"  font="EmphasisFont" text="State goes here" textlocalekey="lblState"/> </td>
                              <td width="10" > </td>
                              <td align="Left"> <salmon:input type="state" name="ddlState" codes="True" datasource="dsUserDetail:user_detail.state"></salmon:input> </td>
                            </tr>
                            <tr> 
                              <td align="Right"> <salmon:text name="capTeZip" text="Zip goes here" font="EmphasisFont" textlocalekey="lblZip"/> </td>
                              <td width="10" > </td>
                              <td align="Left"> <salmon:input type="zip" name="teZip" extendedzip="False" datasource="dsUserDetail:user_detail.zip"></salmon:input> </td>
                            </tr>
                            <tr> 
                              <td align="Right"> <salmon:text name="capDdlCountry" text="Country goes here" font="EmphasisFont" textlocalekey="lblCountry"/> </td>
                              <td width="10" > </td>
                            ...
                            <tr> 
                              <td align="Right"> <salmon:text name="capDdlCardType" text="Credit card type goes here" font="EmphasisFont" textlocalekey="lblCardType"/> </td>
                              <td width="10" > </td>
                            ...
                            <tr> 
                              <td align="Right"> <salmon:text name="capDdlYear" text="CC Exp date goes here" font="EmphasisFont" textlocalekey="lblCardExpDate"/> </td>
                              <td width="10" > </td>
                      ...
                      <tr> 
                        <td><salmon:input type="submit" name="btnSubmit"  classname="sbttn" displaynamelocalekey="btnLblSubmit"></salmon:input></td>
                      </tr>
                    </table>
