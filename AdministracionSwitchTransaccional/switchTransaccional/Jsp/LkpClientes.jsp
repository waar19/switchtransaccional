...
<html>
<salmon:page
   controller="infraestructura.controllers.LkpClientesController" />
<salmon:body />
<salmon:form name="pageForm">
   ...
   <salmon:datasource name="dsCliente" type="MODEL"
   ...
   <salmon:box name="box1" width="100%">
      <salmon:searchformdisplaybox name="searchformdisplaybox1"
         caption="Clientes" qbebuilder="dsQBE"
   ...
   <salmon:box name="box2" width="100%">
      <salmon:listformdisplaybox name="listformdisplaybox1"
         ...
         <salmon:datatable name="datatable1" width="100%"
            rowsperpage="5" datasource="dsCliente">
