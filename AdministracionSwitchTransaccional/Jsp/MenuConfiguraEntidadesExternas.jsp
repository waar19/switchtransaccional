...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
	<tr> 
  		<td> <table width="100%">
      		...
      		<tr> 
        		<td><br><br><salmon:text name="text2" text="Administra Entidades externas (Clientes, proveedores, etc.)" textlocalekey="textWelcome" font="PageHeadingFont"/> <BR>
					 <FONT STYLE="FONT-FAMILY:Times New Roman, Times, Verdana,Helvetica,sans-serif; FONT-SIZE:12pt;" COLOR="BLACK"><I> Configuración de todo tipo de entidades externas de uso en la aplicaión. </I> </FONT><br><br>
				</td>
      		</tr>
    	</table></td>
	</tr>
