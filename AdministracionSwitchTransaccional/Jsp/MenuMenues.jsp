...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
	<tr> 
  		<td> <table width="100%">
      		...
      		<tr> 
        		<td><br><br><salmon:text name="text2" text="Configuración de menús y acceso a la aplicación" textlocalekey="textWelcome" font="PageHeadingFont"/> <BR>
					 <FONT STYLE="FONT-FAMILY:Times New Roman, Times, Verdana,Helvetica,sans-serif; FONT-SIZE:12pt;" COLOR="BLACK"><I> Configuración de los menús de la aplicación, y su acceso según el usuario </I> </FONT><br><br>
				</td>
      		</tr>
    	</table></td>
	</tr>
